...
const BitcoinCard = () => {
    const [bitcoin, setBitcoin] = useState({ chartName: '', bpi: { USD: { rate: '' }, GBP: { rate: '' }, EUR: { rate: '' } } });
    ...
    <div className="bg-[#1c1c1c] p-5 flex flex-col rounded-[20px] max-h-[350px]">
      ...
      <div className="flex flex-col mt-5">
        <div className="flex flex-row justify-evenly items-center">
            <img src="https://cryptologos.cc/logos/bitcoin-btc-logo.png" alt="Bitcoin" className="w-[50px] h-[50px]" />
